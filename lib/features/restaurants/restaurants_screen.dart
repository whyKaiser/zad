        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(loc.remainingToday, style: TextStyle(fontSize: 14, color: c.textSecondary), maxLines: 1, overflow: TextOverflow.ellipsis)),
              Flexible(child: Text('$remaining', style: TextStyle(fontSize: 20, letterSpacing: 20 * -0.01, fontWeight: FontWeight.w700, color: c.accent), maxLines: 1, overflow: TextOverflow.ellipsis)),
              const SizedBox(width: 4),
              Flexible(child: Text(loc.calorieUnit, style: TextStyle(fontSize: 12, color: c.textSecondary), maxLines: 1, overflow: TextOverflow.ellipsis)),
            ]),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            const SizedBox(width: 10),
            Expanded(child: Text(loc.isAr ? restaurant.nameAr : restaurant.nameEn,
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: c.textPrimary), maxLines: 1, overflow: TextOverflow.ellipsis)),
            Icon(Icons.place_outlined, size: 14, color: c.textTertiary),
            const SizedBox(width: 2),
            Flexible(child: Text('${restaurant.distanceM} ${loc.meters}',
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Flexible(child: Text('$cals',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: fits ? c.accent : c.textSecondary), maxLines: 1, overflow: TextOverflow.ellipsis)),
              const SizedBox(width: 4),
              Flexible(child: Text(loc.calorieUnit, style: TextStyle(fontSize: 11, letterSpacing: 11 * 0.01, color: c.textSecondary), maxLines: 1, overflow: TextOverflow.ellipsis)),
            ]),
          ),
        ],
      ),
