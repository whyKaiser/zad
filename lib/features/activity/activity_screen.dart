          ...
          children: [
            Padding(
              ...
              child: Row(children: [
                ...
                Flexible(child: Text(loc.isAr ? 'النشاط والحركة' : 'Activity',
                        ...
                        return Dismissible(
                          ...
                          child: Container(
                            ...
                            child: Row(children: [
                              ...
                              Flexible(child: Text('${e.calories}',
                                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: c.accent2), maxLines: 1, overflow: TextOverflow.ellipsis)),
                              Flexible(child: Text(' ${loc.calorieUnit}',
                                  style: TextStyle(fontSize: 10, letterSpacing: 10 * 0.02, color: c.textTertiary), maxLines: 1, overflow: TextOverflow.ellipsis)),
                            ]),
                          ),
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, scrollCtrl) => Column(children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: Row(children: [
            Expanded(child: Text(loc.isAr ? 'سجّل نشاط' : 'Log activity',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: c.textPrimary), maxLines: 1, overflow: TextOverflow.ellipsis)),
            Flexible(child: Text('$cals ${loc.calorieUnit}',
                style: TextStyle(fontSize: 20, letterSpacing: 20 * -0.01, fontWeight: FontWeight.w700, color: c.accent2), maxLines: 1, overflow: TextOverflow.ellipsis)),
          ]),
        ),
        const SizedBox(height: 12),
        Expanded(
